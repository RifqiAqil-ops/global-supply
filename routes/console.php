...
Schedule::command('gscrip:sync-countries')->weekly()->withoutOverlapping();

// 2. Exchange Rates - Every 1 Hour
Schedule::command('gscrip:sync-exchange')->hourly()->withoutOverlapping();

// 3. Open-Meteo Weather Forecasts - Every 30 Minutes
Schedule::command('gscrip:sync-weather')->everyThirtyMinutes()->withoutOverlapping();

// 4. World Bank Macroeconomic Indicators - Daily
Schedule::command('gscrip:sync-worldbank')->daily()->withoutOverlapping();
