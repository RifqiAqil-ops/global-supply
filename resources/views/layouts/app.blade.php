                                                ...
                                                <div class="card card-premium border-0 h-100" style="transition: transform 0.2s;">
                                                    ...
                                                    <div class="card-body d-flex flex-column">
                                                        ...
                                                        <div class="d-flex align-items-center justify-content-between mt-auto">
                                                            ...
                                                            ${a.source_url && !a.source_url.includes('example.com') && !a.source_url.includes('gnews.io') ? `<a href="${a.source_url}" target="_blank" rel="noopener noreferrer" class="btn btn-sm btn-outline-primary py-0 px-2 small"><i class="bi bi-box-arrow-up-right me-1"></i>Source</a>` : `<span class="badge bg-secondary opacity-75 font-monospace text-uppercase" style="font-size: 0.68rem;">Demo Data</span>`}
                                                        </div>
                                                    </div>
                                                </div>
                                            </div>
